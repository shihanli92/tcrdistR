...
**691 tests, R CMD check: 0 errors, 0 warnings, 2 NOTEs** (C++14,
extdata size)
...
`compute_tcrdist_kernel_pca` **CD8 scoring:**
`make_cd8_score_table_column` **Diversity:** `tcr_diversity`,
...
**Joins:** `tcrdist_join` **Visualization:** `plot_cdr3_logo`,
...
`read_tcr_table` **Utilities:** `load_gene_database`, `get_translation`,
`reverse_complement`, `trim_allele_to_gene`, `AMINO_ACIDS`, `TCRrep`
