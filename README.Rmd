...
sequence comparisons using BLOSUM62-derived substitution matrices. Supports
paired alpha-beta and single-chain (beta-only or alpha-only) input, per-component
distance decomposition, and targets feature parity with Python
